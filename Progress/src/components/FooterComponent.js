            ...
            <div className="row justify-content-center">             
                ...
                <div className="col-12 col-sm-4 align-self-center">
                    <div className="text-center">
                        ...
                        <a className="btn btn-social-icon btn-facebook" href="https://www.facebook.com/usernam.curently.not.avilabl"><i className="fa fa-facebook"></i></a>
                        <a className="btn btn-social-icon btn-linkedin" href="https://www.linkedin.com/in/satyam-goyal26/"><i className="fa fa-linkedin"></i></a>
